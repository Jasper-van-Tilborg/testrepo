...
export default function Header({ title = "Mijn Website", className = "" }: HeaderProps) {
  ...
  return (
    <header className={`bg-white dark:bg-gray-900 shadow-lg border-b border-gray-200 dark:border-gray-700 ${className}`}>
